  ...
  const sections = [
    ...
    // ✅ الإلكترونيات
    {
      ...
      products: [
        ...
        { id: 7, img: keyboard, name: "كيبورد RGB", desc: "تصميم احترافي", oldPrice: 250, price: 180, rate: 4.7, discount: 20 },
  ...
  return (
    <div className="products-wrapper">
      {sections.map((sec, index) => (
        <div key={index}>
          <div className="customer-products-header container pt-5 pb-3">
...
function ProductCard({ p, navigate }) {
  return (
    ...
    >
      ...
      <p className="customer-desc" dangerouslySetInnerHTML={{ __html: p.desc }}></p>
